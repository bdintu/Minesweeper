...
#define LCD_CS_GPIO_CLK        RCC_APB2ENR_IOPCEN 				 //RCC_APB2Periph_GPIOC  ((uint32_t)0x00000010)

#define LCD_BL_PIN             GPIO_PIN_7                  // PD7 = BL GLCD
#define LCD_BL_GPIO_PORT       GPIOD
#define LCD_BL_GPIO_CLK        RCC_APB2ENR_IOPDEN					 //RCC_APB2Periph_GPIOD  ((uint32_t)0x00000020)
...
#define LCD_SPI_GPIO_CLK       RCC_APB2ENR_IOPCEN 				//RCC_APB2Periph_GPIOC
#define LCD_SPI			       		 SPI3
#define LCD_SPI_CLK		       	 RCC_APB1RSTR_SPI3RST				//RCC_APB1Periph_SPI3 ((uint32_t)0x00008000)
...
// PE6(CS#)	 -->
// PE7(SCK)	 -->
#define TCS_GPIO_CLK           RCC_APB2ENR_IOPEEN					//RCC_APB2Periph_GPIOE
